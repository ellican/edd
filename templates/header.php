...
if ($isLoggedIn) {
    try {
        ...
        error_log("Error fetching header counts: " . $e->getMessage());
    }
}
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            .feza-main-header.scroll-down {
                transform: translateY(-100%);
            }
            
            /* Show header when scrolling up */
            .feza-main-header.scroll-up {
            ...
            <div class="feza-header-icons feza-header-icons-desktop">
                <a href="/notifications.php" class="feza-header-icon" title="Notifications">
                    ...
                    <?php if ($unreadNotificationCount > 0): ?>
                        <span class="feza-notification-badge"><?php echo min($unreadNotificationCount, 99); ?></span>
                    <?php endif; ?>
                </a>
