...
<div id="supportTicketModal" class="modal" style="display: none;">
    <div class="modal-content">
        <div class="modal-header">
            <h3>Create Support Ticket</h3>
            <button class="modal-close" onclick="closeSupportTicketModal()">&times;</button>
        </div>
        <form id="supportTicketForm" onsubmit="submitSupportTicket(event)" class="modal-form">
            <div class="form-group">
                <label for="ticket_subject">Subject *</label>
                <input type="text" name="subject" id="ticket_subject" class="form-control" required maxlength="255">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="message" id="ticket_message" class="form-control" rows="5" required minlength="10"></textarea>
            </div>
            
            <div class="modal-actions">
                <button type="button" class="btn btn-outline" onclick="closeSupportTicketModal()">Cancel</button>
...
async function submitSupportTicket(event) {
    ...
    try {
        const response = await fetch('/api/account/create-ticket.php', {
            method: 'POST',
        ...
        if (result.success) {
            alert('Support ticket created successfully!\nTicket Number: ' + result.data.ticket_number);
            closeSupportTicketModal();
            // Reload support tickets if on the support tab
...
<div id="addPaymentMethodModal" class="modal" style="display: none;">
    <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
            <p class="text-muted mb-3">Add a payment method for faster checkout</p>
            <form id="payment-method-form">
                <div id="card-element" style="padding: 12px; border: 1px solid #ccc; border-radius: 4px; margin-bottom: 15px;">
                    <!-- Stripe Card Element will be inserted here -->
                </div>
                <div id="card-errors" role="alert" style="color: #fa755a; margin-bottom: 15px;"></div>
                <div class="form-group">
                    <label>
                        <input type="checkbox" id="set-default-payment" checked>
                        Set as default payment method
                    </label>
                </div>
                <div class="modal-actions">
                    <button type="button" class="btn btn-outline" onclick="closeAddPaymentMethodModal()">Cancel</button>
                    <button type="submit" class="btn btn-primary" id="submit-payment-method">Add Payment Method</button>
                </div>
            </form>
        </div>
    </div>
...
<div id="addFundsModal" class="modal" style="display: none;">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <button class="modal-close" onclick="closeAddFundsModal()">&times;</button>
        </div>
        <div class="modal-body">
            <form id="add-funds-form" onsubmit="submitAddFunds(event)">
                <div class="form-group">
                    <label for="add-funds-amount">Amount *</label>
                    <input type="number" id="add-funds-amount" name="amount" class="form-control" 
                           min="1" step="0.01" required placeholder="Enter amount">
                </div>
                <div class="form-group">
                    <label for="add-funds-method">Payment Method *</label>
                    <select id="add-funds-method" name="payment_method" class="form-control" required>
                ...
                <div class="modal-actions">
                    <button type="button" class="btn btn-outline" onclick="closeAddFundsModal()">Cancel</button>
...
<div id="transferFundsModal" class="modal" style="display: none;">
    <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
            <form id="transfer-funds-form" onsubmit="submitTransfer(event)">
                <div class="form-group">
                    <label for="transfer-recipient">Recipient Email or Username *</label>
                    <input type="text" id="transfer-recipient" name="recipient" class="form-control" 
                           required placeholder="user@example.com or @username">
                </div>
                <div class="form-group">
                    <label for="transfer-amount">Amount *</label>
                    <input type="number" id="transfer-amount" name="amount" class="form-control" 
                           min="0.01" step="0.01" required placeholder="Enter amount">
                </div>
                <div class="form-group">
                    <label for="transfer-description">Description (Optional)</label>
                    <textarea id="transfer-description" name="description" class="form-control" 
                              rows="3" placeholder="What is this transfer for?"></textarea>
                </div>
                <div class="modal-actions">
...
<div id="withdrawFundsModal" class="modal" style="display: none;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="withdraw-funds-form" onsubmit="submitWithdraw(event)">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select id="withdraw-method" name="withdrawal_method" class="form-control" required>
                ...
                <div id="withdrawal-details" style="display: none;">
                    <!-- Withdrawal method specific fields will be inserted here -->
                </div>
                <div class="form-group">
                    <label for="withdraw-notes">Notes (Optional)</label>
                    <textarea id="withdraw-notes" name="notes" class="form-control" 
