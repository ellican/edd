...
$stmt = $db->prepare("SELECT * FROM seller_kyc WHERE vendor_id = ? ORDER BY submitted_at DESC LIMIT 1");
            ...
            <div class="kyc-status-card">
                ...
                <div class="status-details">
                    ...
                    <div class="detail-item">
                        ...
                        <span><?php echo date('F j, Y g:i A', strtotime($existingKyc['submitted_at'])); ?></span>
                    </div>
