...
try {
    ...
    error_log("Currency initialization error on product page: " . $e->getMessage());
}
...
<div class="product-container">
    ...
    <div class="product-layout">
        ...
        <div class="purchase-panel">
            ...
            <button class="btn btn-outline" onclick="askAboutProduct()">
...
// Ask about product - Start product inquiry conversation
async function askAboutProduct() {
    ...
    try {
        const response = await fetch('/api/messages/start.php', {
            method: 'POST',
            headers: {
        ...
        if (data.success) {
            showToast('Opening message center...', 'success');
            setTimeout(() => {
